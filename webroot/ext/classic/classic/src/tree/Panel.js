 ...
 *
 *     @example
 *     Ext.define('APPDSS.TerritoryRoot', {
 *         extend: 'Ext.data.TreeModel',
 *         childType: 'APPDSS.Territory',
 *         fields: [{
 *             name: 'text',
 *             mapping: 'name'
 *         }]
 ...
 *         rootVisible: false,
 *         store: {
 *             model: 'APPDSS.TerritoryRoot', // Needs to be this so it knows to create 'Country' child nodes
 *             root: {
 *                 children: [{
 *                     name: 'Europe, ME, Africa',
 *                     children: [{
