 ...
 *         autoCreateViewport: 'APPDSS.view.Main'
 *     });
 *
 * This does several things. First it creates a global variable called 'APPDSS' - all of
 ...
 *
 * The APPDSS global will also have a getApplication method to get a reference to the current
 * application:
 *
 *     var app = APPDSS.getApplication();
 *
 ...
 *
 *     Ext.define('APPDSS.controller.Posts', {
 ...
 *     });
 *
 *     Ext.application('APPDSS.Application');
 *
...
Ext.define('Ext.app.Application', {
     ...
     *     controllers: '.Main' // or 'APPDSS.controller.Main'
     * 
     *     // while the following would be located at:
     *     // app/controller/customer/Main.js
     *     controllers: 'customer.Main' // or 'APPDSS.controller.customer.Main'
     * 
     ...
     *      });
     *
     *      Ext.define('APPDSS.controller.Bar', {
     *          extend: 'Ext.app.Controller',
     *
     *          models: ['Foo'],    // Loads APPDSS.model.Foo
     *          views:  ['Bar']     // Loads APPDSS.view.Bar
     *      });
     *
     * You don't need to include main namespace (APPDSS), it will be added to the list
     * automatically.
     */
    namespaces: [],
    ...
    config: {
         ...
         *
         *         launch: function() {
         *             console.log(APPDSS.myProp === this);
         *         }
         *     });
         */
        appProperty: 'app',
        ...
        */
         ...
         *         name : 'APPDSS',
         *
         *         mainView: 'APPDSS.view.main.Main'
         *         // mainView: 'main.Main'
         *         // mainView: new APPDSS.view.main.Main()
     ...
     * full class name `APPDSS.controller.Foo`, the name parameter should be `Foo`.
     ...
     * 'APPDSS.profile.MyProfile'). This just makes sure everything ends up fully qualified.
     * @private
     */
