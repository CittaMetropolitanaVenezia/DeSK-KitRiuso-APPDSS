 ...
 *
 *      Ext.define('APPDSS.controller.Users', {
...
Ext.define('Ext.app.Controller', {
    ...
    statics: {
         ...
         *
         *      Ext.app.Controller.processDependencies(proto, requiresArray, 'APPDSS', 'model', [
         *          'User',
         *          'Item',
         *          'Foo@Common.model',
     ...
     *
     *      Ext.define("APPDSS.controller.Foo", {
     *          extend: "Ext.app.Controller",
     *          models: ['User', 'Vehicle']
     *      });
     *
     ...
     *      Ext.define("APPDSS.controller.Foo", {
     *          extend: "Ext.app.Controller",
     *          requires: ['APPDSS.model.User', 'APPDSS.model.Vehicle'],
     *          
     ...
     *      Ext.define("APPDSS.controller.Foo", {
     *          extend: "Ext.app.Controller",
     *          requires: ['APPDSS.view.List', 'APPDSS.view.Detail'],
     *          
