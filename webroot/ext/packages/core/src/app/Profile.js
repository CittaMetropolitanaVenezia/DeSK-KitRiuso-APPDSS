 ...
 *
 *     Ext.define('APPDSS.profile.Phone', {
...
Ext.define('Ext.app.Profile', {
     ...
     * Profile {@link #name}, for example a Profile called APPDSS.profile.Phone will by default have a 'phone'
     * namespace, which means that this Profile's additional models, stores, views and controllers will be loaded
     * from the APPDSS.model.phone.*, APPDSS.store.phone.*, APPDSS.view.phone.* and APPDSS.controller.phone.* namespaces
     * respectively.
     * @accessor
     */
     ...
     * called APPDSS.profile.Phone will default the name to 'Phone').
     * @accessor
     */
    ...
    config: {
         ...
         *     controllers: [
         *         'Users',
         *         'APPDSS.controller.Products'
         *     ]
         *
         * This will load *APPDSS.controller.tablet.Users* and *APPDSS.controller.Products*.
         * @accessor
         */
        controllers: [],
         ...
         *     ]
         *
         * This will load *APPDSS.model.tablet.Group* and *APPDSS.model.User*.
         * @accessor
         */
        models: [],
         ...
         *
         *      views: {
         *          // The "main" xtype maps to APPDSS.view.tablet.Main
         *          //
         *          main: 'APPDSS.view.tablet.Main',
         *
         *          // The "inbox" xtype maps to a subclass of APPDSS.view.Inbox (created
         *          // by this mechanism) that sets the "mode" config to "compact".
         *          //
         *          inbox: {
         *              xclass: 'APPDSS.view.Inbox',
         *              mode: 'compact'
         *          }
         *      }
         *
         ...
         *     ]
         *
         * This will load *APPDSS.view.tablet.Main* and *APPDSS.view.Login*. While supported,
         ...
         *     stores: [
         *         'Users',
         *         'APPDSS.store.Products'
         *     ]
         *
         * This will load *APPDSS.store.tablet.Users* and *APPDSS.store.Products*.
         * @accessor
         */
        stores: []
    },
     ...
     *
     *     launch: function() {
     *         Ext.create('APPDSS.view.tablet.Main');
     *     }
     */
    launch: Ext.emptyFn,
