...
var makeCtor = Ext.Class.makeCtor,
    ...
    Ext.apply(Ext, {
         ...
         * body:
         *
         *      Ext.define('APPDSS.foo.Bar', function () {
         *          var id = 0;
         *
         *          return {
         *              nextId: function () {
         ...
         * 
         *      Ext.define('APPDSS.override.BaseOverride', function () {
         *          var counter = 0;
         *
         *          return {
         ...
         * may have:
         *
         *      Ext.define('APPDSS.foo.Bar', function (Bar) {
         *          return {
         *              statics: {
     ...
     *      });
     *
     * In the above example, `APPDSS` and `Common` are top-level namespaces that happen
     ...
     *
     *      var APPDSS = APPDSS || {};
     *      Ext.addRootNamespaces({ APPDSS: APPDSS );
     *
