 ...
 * files will not be loaded until the `APPDSS.view.Main` class indicates they are needed
 * as shown above.
 *
 * # Loading Classes
 *
 ...
 * For example:
 *
 *      Ext.require('APPDSS.view.Main', function () {
 *          // On callback, the APPDSS.view.Main class is now loaded
 *
 *          var view = new APPDSS.view.Main();
 *      });
 *
