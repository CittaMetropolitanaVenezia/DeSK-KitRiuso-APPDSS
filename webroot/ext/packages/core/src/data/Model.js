...
Ext.define('Ext.data.Model', {
     ...
     *
     *      Ext.define('APPDSS.data.MyModel', {
     *          extend: 'Ext.data.Model',
     ...
     *
     *      Ext.define('APPDSS.data.MyModelX', {
     *          extend: 'Ext.data.Model',
     *          identifier: {
     *              type: 'sequential',
     *              id: 'xy'
     ...
     *      });
     *
     *      Ext.define('APPDSS.data.MyModelY', {
     *          extend: 'Ext.data.Model',
     *          identifier: {
     *              type: 'sequential',
     *              id: 'xy'
     ...
     *      });
     * 
     *      var nameOrdinal = APPDSS.models.User.fieldOrdinals.name;
     *      
     *      // or, if you have an instance:
     *
     *      var user = new APPDSS.models.User();
     ...
     * 
     *     Ext.define('APPDSS.model.Employee', {
     *         extend: 'Ext.data.Model',
     ...
     *     });
     *     
     *     var tina = Ext.create('APPDSS.model.Employee', {
     *         salary: 50000,
     *         yearsOfService: 3
     *     });
     *     
     ...
     * followed by the instance ID - for example an instance of APPDSS.model.User with ID 123 will return 'user/123'.
     ...
     *     });
     *
     *     var user = new APPDSS.model.User({
     *         name: 'Foo'
     *     });
     *
