...
Ext.define('Ext.data.TreeModel', {
     ...
     *    store: {
     *        id: 'myTreeStore',
     *        model: 'APPDSS.World' // The hidden root will know to create 'Territory' type children.
     *    }
     *
     * If the root is hidden, and the first level of visible nodes are going to be the `APPDSS.Territory` class,
     * then the hidden root must not be of the `APPDSS.Territory` class. Otherwise, it would try to read in the
