...
Ext.define('Ext.data.field.Field', {
     ...
     *      });
     *
     *      var barField = APPDSS.models.Foo.getField('bar');
     *
     *      alert(barField.definedBy === APPDSS.models.Foo); // alerts 'true'
     *
     * When a field is inherited, this value will reference the class that originally
     * defined the field.
     *
     *      Ext.define('APPDSS.models.Base', {
     *          extend: 'Ext.data.Model',
     *
     *          fields: [
     *              { name: 'foo' }
     ...
     *      });
     *
     *      Ext.define('APPDSS.models.Derived', {
     *          extend: 'APPDSS.models.Base',
     *
     *          fields: [
     *              { name: 'bar' }
     *          ],
     ...
     *      });
     *
     *      var fooField = APPDSS.models.Derived.getField('foo');
     *
     *      alert(fooField.definedBy === APPDSS.models.Base); // alerts 'true'
     */
    definedBy: null,
