 ...
 *
 *      api: {
 *          read: 'APPDSS.readRecords',
 *          create: 'APPDSS.createRecords',
 *          update: 'APPDSS.updateRecords',
 *          destroy: 'APPDSS.destroyRecords'
 *      }
 *
...
Ext.define('Ext.data.proxy.Direct', {
    ...
    config: {
        ...
        * for example: `'APPDSS.company.GetProfile'`. This can be useful when using dynamic loading.
        ...
        *   }
        *
        * This way function names will be resolved to `'APPDSS.readRecords'`, `'APPDSS.createRecords'`,
