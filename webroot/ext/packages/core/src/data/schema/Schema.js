 ...
 * In the following code, `"APPDSS.model.Foo"` has an `entityName` of `"Foo"` and the schema has
 * a `namespace` of "APPDSS.model".
 * 
 ...
 *
 *          schema: {
 *              namespace: 'APPDSS.model'
 *          }
 *      });
 *
 * Your derived classes now will generate proper default `entityName` values even if they
 * have further namespaces. For example, "APPDSS.model.foo.Thing" will produce "foo.Thing"
 ...
 *
 *      Ext.define('APPDSS.model.CustomNamer', {
